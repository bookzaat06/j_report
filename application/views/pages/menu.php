		...
		<div id="m_ver_menu" class="m-aside-menu  m-aside-menu--skin-dark m-aside-menu--submenu-skin-dark " data-menu-vertical="true" data-menu-scrollable="false" data-menu-dropdown-timeout="500">
			<ul class="m-menu__nav  m-menu__nav--dropdown-submenu-arrow ">
				...
				foreach ($query->result_array() as $row) {
					?>
					<li class="m-menu__item  m-menu__item--submenu <?php if (urldecode($main) == $row['name']) echo 'm-menu__item--open m-menu__item--expanded'; ?>" aria-haspopup="true" data-menu-submenu-toggle="hover">
						...
						<div class="m-menu__submenu">
							...
							foreach ($submenu as $key => $value) {
								?>
									...
									<li class="m-menu__item <?php if (urldecode($sub) == $value) echo 'm-menu__item--active'; ?>" aria-haspopup="true">
										<a href="../<?= $row['name'] . '/' . $value; ?>" class="m-menu__link m-menu__toggle">
